...
import { Link as MUILink, Dialog, DialogActions, TextField, DialogContent } from "@mui/material";
...
const SearchDialog = (props) => {
  const { searchDialogOpen, handleCloseSearch, searchValue, setSearchValue, handleSearchSubmit } = props;
  return (
    <Dialog open={searchDialogOpen} onClose={handleCloseSearch}>
    ...
    >
      <Toolbar>
        ...
        <Box sx={{ flexGrow: 1, display: { xs: "flex", sm: "none" } }}>
          ...
          >
            <NestedMenuItem label={"Category"} parentMenuOpen={!!anchorElMenu}>
